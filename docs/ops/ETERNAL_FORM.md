...
Альтернативный вариант, если отказ решим не упоминать (445/500) — последний
абзац заменить на:

```
No outside money has gone into this. Mainnet deploys, verified programs, the whole product — self-funded.
```
