...
3. ПОЛУЧАТЕЛЬ (родители Лены, или Лена со свежим адресом)
   ├── Получает DepositNote offchain (текстовый формат с secret + nullifier)
...
- **No onchain coordination** — аудитор сканирует события offchain, нет protocol-level disclosure механизма
