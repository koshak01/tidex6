// HatLogo.jsx — векторный логотип tidex6 (React, JS)
// Brand colors: #9945FF (Solana Purple), #14F195 (Solana Green)
//
// Usage:
//   <HatLogo />                            // моно фиолет (по умолчанию)
//   <HatLogo color="#14F195" />            // моно зелёный
//   <HatLogo gradient />                   // brand gradient, горизонтальный
//   <HatLogo gradient angle={45} />        // диагональный gradient
//   <HatLogo size={120} gradient />        // hero-размер
//   <HatLogo size={32} />                  // navbar-размер
...
const HatLogo = ({
  ...
  gradientFrom = '#9945FF',
  gradientTo = '#14F195',
  gradientMid,                  // опциональный 3-й stop (например '#19B4D4')
  angle = 0,                    // 0 = горизонталь, 45 = диагональ, 90 = вертикаль
  className = '',
  ...rest
}) => {
