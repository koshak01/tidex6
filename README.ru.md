...
│   ├── tidex6-tip-jar/          — ADR-013 референс CPI-интеграция (деплой + OtterSec апрель 2026, деплой закрыт)
